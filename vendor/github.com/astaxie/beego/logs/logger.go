...
func formatTimeHeader(when time.Time) ([]byte, int) {
	y, mo, d := when.Date()
	h, mi, s := when.Clock()
	// 修改Logger组件第一列毫秒显示效果 Add: tianyuliang Since: 2017/10/12
	// 1507783030223366100 --> find millisecond "223", index10->13
	millisecond := []byte(strconv.FormatInt(when.UnixNano(), 10)[10:13])

	//len("2006/01/02 15:04:05 ")==20
	//var buf [20]byte

	//len("2006/01/02 15:04:05.167 ")==24
	var buf [24]byte
	...
	buf[18] = s2[s]
	buf[19] = '.'
	buf[20] = millisecond[0]
	buf[21] = millisecond[1]
	buf[22] = millisecond[2]
	buf[23] = ' '
