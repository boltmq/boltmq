...
func (processor *GetTopicStatsInfoProcessor) ProcessRequest(ctx core.Context,
...
func initServer() {
	...
	remotingServer.RegisterProcessor(protocol.GET_TOPIC_STATS_INFO, &GetTopicStatsInfoProcessor{})
