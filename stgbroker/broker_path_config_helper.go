...
func getConsumerOffsetPath(rootDir string) string {
	return rootDir + string(os.PathSeparator) + "config" + string(os.PathSeparator) + "consumerOffset.json"
}
...
func getSubscriptionGroupPath(rootDir string) string {
	return rootDir + string(os.PathSeparator) + "config" + string(os.PathSeparator) + "subscriptionGroup.json"
}
